...
// if (inStock < 20) {
    ...
    // } else {
        ...
        if (inStock >= 1) {
            ...
            console.log(`We nede to get some more ${food}`)
        };
        ...
        var vegetables = ['leeks', 'squash', 'zuccini', 'carrots', 'raddish']
        ...
        var fruits = ['lemon', 'cherry', 'watermelon', 'apple', 'grapes', 'kiwi', 'blueberry']
